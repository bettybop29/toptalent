...
<div class="container-fluid-sm-lg-md">
  <NavBasic></NavBasic>
    ...
    <div class="main" style="background-image: linear-gradient(#006EFF,#131212);">
      <div class="d-flex justify-content-center" style="padding: 80px; color: white; text-align: center;">
