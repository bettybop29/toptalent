    ...
    <div class="align-content-center">
      ...
      <div class="card animate__animated animate__bounceIn">
        <div class="card-title">
          <p>
            “I was freshgraduate until I found toptalent and I find a suitable
            job here. I can’t imagine what happened to my career without
            toptalent.oke”
          </p>
          <div class="footer">
      ...
      <div class="container animate__animated animate__fadeInDown">
        ...
        <div class="form-login animate_animated animate_fadeInDown">
          <form action="" @submit.prevent="login">
            ...
            <p>
              <router-link class="forgot" to="/resetpass"
            ...
            <p class="sign-up mt-4">
              ...
              <router-link class="forgot" to="/signup"
    ...
    async login() {
      ...
      if (response.status == 200) {
        ...
        localStorage.setItem(
          "user-info",
          JSON.stringify(response.data.data.registerDTO)
        );
        this.$router.push("/dashboard");
        this.$toast.success(
          `Welcome back! ${response.data.data.registerDTO.recruiterCompany}`,
          {
