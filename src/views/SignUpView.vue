<template>
  <div class="container-fluid min-vh-100 d-flex flex-column">
    <div class="row flex-grow-1">
      <div class="col-md-6">
        <img class="img-fluid" src="../assets/signup-image.png" alt="">
        <div tag="article" class="card mb-2 card-testimony d-none d-md-block d-lg-block">
        ...
        <div class="form-login">
          <form action="" @submit.prevent="signUp" class="row">
            ...
            <div class="col-12">
              ...
              <input type="password" v-model="recruiterPassword" class="form-control" id="password"
            ...
            <div class="col-12">
              ...
              <input type="text" v-model="recruiterIndustry" class="form-control" id="industry"
                placeholder="eg: Technology, Financial" required />
            </div>
